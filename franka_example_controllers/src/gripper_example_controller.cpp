...
CallbackReturn GripperExampleController::on_configure(const rclcpp_lifecycle::State&) {
  ...
  velocity_subscription_ = get_node()->create_subscription<std_msgs::msg::Float64>(
      ...
      std::bind(&GripperExampleController::velocityCommandCallback, this, std::placeholders::_1));
  ...
  position_subscription_ = get_node()->create_subscription<std_msgs::msg::Float64>(
    ...
    std::bind(&GripperExampleController::positionCommandCallback, this, std::placeholders::_1));

  // Create subscription to joint states
  joint_states_sub_ = get_node()->create_subscription<sensor_msgs::msg::JointState>(
    "/joint_states", 10,
    std::bind(&GripperExampleController::jointstatesCallback, this, std::placeholders::_1));
...
void GripperExampleController::velocityCommandCallback(const std_msgs::msg::Float64::SharedPtr msg) {
...
void GripperExampleController::positionCommandCallback(const std_msgs::msg::Float64::SharedPtr msg) {
...
void GripperExampleController::jointstatesCallback(const sensor_msgs::msg::JointState::SharedPtr msg) {
